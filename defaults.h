...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_AXIS1_STEPS_PER_UNIT 1066//(MICROSTEPS_AXIS1*STEP_REVS_AXIS1/UNIT_PER_REV_AXIS1) // 400
  ...
  #define DEFAULT_AXIS2_STEPS_PER_UNIT 1066 //(MICROSTEPS_AXIS2*STEP_REVS_AXIS2/UNIT_PER_REV_AXIS2)
  ...
  #define DEFAULT_AXIS3_STEPS_PER_UNIT 1066 //(MICROSTEPS_AXIS3*STEP_REVS_AXIS3/UNIT_PER_REV_AXIS3)
  #define STEP_MAX_FREQUENCY 5000
  #define SECONDS_PER_MINUTE 60
  #define DEFAULT_AXIS1_MAX_RATE 800.0 // 9000 mm/min = 9000/60 = 150 mm/sec
  //#define DEFAULT_AXIS1_MAX_RATE (STEP_MAX_FREQUENCY/DEFAULT_AXIS1_STEPS_PER_UNIT*SECONDS_PER_MINUTE) // 3000
  #define DEFAULT_AXIS2_MAX_RATE 800.0 // 9000 mm/min = 9000/60 = 150 mm/sec
  //#define DEFAULT_AXIS2_MAX_RATE (STEP_MAX_FREQUENCY/DEFAULT_AXIS2_STEPS_PER_UNIT*SECONDS_PER_MINUTE)
  #define DEFAULT_AXIS3_MAX_RATE 800.0  //  300 mm/min =  300/60 =   5 mm/sec
