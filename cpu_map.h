...
#define cpu_map_h
  ...
  #endif
  #if N_AXIS > 5
    #define STEP_BIT_5 3 // Axis number 6 Step - Pin D49
  #endif
  ...
  #endif
  #if N_AXIS > 5
    #define DIRECTION_PORT_5 F // Axis number 6 (Ramps Aux-3 D51)
  #endif
  ...
  #endif
  #if N_AXIS > 5
    #define DIRECTION_BIT_5 5 // Axis number 6 Step - Pin D51
  #endif
  ...
  #endif
  #if N_AXIS > 5
    #define STEPPER_DISABLE_PORT_5 G // Axis number 5 (Ramps Aux-3 D53)
  #endif
  ...
  #endif
  #if N_AXIS > 5
    #define STEPPER_DISABLE_BIT_5 1 // Axis number 5 Step - Pin D53
  #endif
  ...
  #endif
  #if N_AXIS > 5
    #define MIN_LIMIT_BIT_5 5 // Axis number 6 : RAMPS AUX2 pin D57
  #endif
  ...
  #endif
  #if N_AXIS > 4
    #define MAX_LIMIT_BIT_4 2 // Axis number 5 : RAMPS AUX2 pin D59
  #endif
  #if N_AXIS > 5
  ...
  // Define spindle enable and spindle direction output pins.
  #define SPINDLE_ENABLE_DDR      DDRJ
  #define SPINDLE_ENABLE_PORT     PORTJ
  #define SPINDLE_ENABLE_BIT      0 // MEGA2560 Digital Pin 4 - Ramps 1.4 Servo 4 Signal pin (D4)
  #define SPINDLE_DIRECTION_DDR   DDRE
  #define SPINDLE_DIRECTION_PORT  PORTE
  #define SPINDLE_DIRECTION_BIT   4 // MEGA2560 Digital Pin 5 - Ramps 1.4 Servo 3 Signal pin (D5)

  // Define flood and mist coolant enable output pins.
  #define COOLANT_FLOOD_DDR   DDRH
  #define COOLANT_FLOOD_PORT  PORTH
  #define COOLANT_FLOOD_BIT   5 // MEGA2560 Digital Pin 7 - Ramps 1.4 12v output
  #define COOLANT_MIST_DDR    DDRH
  #define COOLANT_MIST_PORT   PORTH
  #define COOLANT_MIST_BIT    5 // MEGA2560 Digital Pin 8 - Ramps 1.4 12v output
